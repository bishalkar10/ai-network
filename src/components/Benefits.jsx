...
const Benefits = () => {
  return (
<section id='benefits'  className="flex flex-col justify-start items-center bg-[#060A14] px-3 pt-20 w-full min-h-screen flex-wrap">
<h2 className="text-center text-white text-3xl uppercase pb-10 font-bold">
Benefits
      </h2>
      <img src="/ai-7.jpg" className='rounded mb-8 hover:ring-2 ring-[#59C09D]' alt="" width={250} height={380} />
